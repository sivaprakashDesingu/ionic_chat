...
export class DashPage implements OnInit {
  ...
  enableUProfile() {
    ...
    this.http.get(this.appService.API_ENDPOINT + 'userProfileDetails', {
      ...
      .subscribe(data => {
        ...
        this.upro_path = "http://www.sarvaamexporters.com/" + data[0].pro_path+"?"+time;
        this.ucover_path = "http://www.sarvaamexporters.com/" + data[0].cover_path+"?"+time;
        console.log("cover image: "+this.ucover_path);
      },
      err => console.log(err),
      () => console.log());
  ...
  getUserProfilePic() {
    this.http.get(this.appService.API_ENDPOINT + 'getUserProfilePic', {
      ...
      .subscribe(data => {
        this.lupic = "http://www.sarvaamexporters.com/" + data[0].pro_path+"?"+this.appService.currentDate();
      },
      err => console.log(err),
      () => console.log());
  }
